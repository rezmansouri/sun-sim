...
class ConvBlock(torch.nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, conv_type = 'graph', batch_norm=True, relu_activation=True, **kwargs):
        ...
        self.bn = BatchNorm1d(out_channels, track_running_stats=True)
...
class UNetSpherical(UNet, torch.nn.Module):
    ...
    def encode(self, x):
        ...
        x_enc1 = x_enc1 + self.conv1_res(x)
        ...
        x_enc2 = x_enc2 + self.conv2_res(x_enc2_ini)
        ...
        x_enc3 = x_enc3 + self.conv3_res(x_enc3_ini)
