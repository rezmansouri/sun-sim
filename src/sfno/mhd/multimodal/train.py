...
def main():
    ...
    train_dataset = SphericalNODataset(
        data_path, cr_train, scale_up=scale_up
    ...
    val_dataset = SphericalNODataset(
        ...
        j_min=train_dataset.j_min,
        j_max=train_dataset.j_max,
        # positional_embedding=pos_embedding
    )
    ...
    cfg = {
        ...
        "j_min": float(train_dataset.j_min),
        "j_max": float(train_dataset.j_max),
    ...
    sfno = SFNO(
        ...
        in_channels=2 * encoder_hidden_channels,
        out_channels=2 * 139,
        hidden_channels=hidden_channels,
        factorization="dense",
